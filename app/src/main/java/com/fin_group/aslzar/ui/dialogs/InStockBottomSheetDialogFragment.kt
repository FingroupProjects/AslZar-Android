 ...
 * Use the [InStockBottomSheetDialogFragment.newInstance] factory method to
...
class InStockBottomSheetDialogFragment : BottomSheetDialogFragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment InStockBottomSheetDialogFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InStockBottomSheetDialogFragment().apply {
